...
var _STAR_html_mode_STAR_5521 = hiccups.runtime._STAR_html_mode_STAR_;
hiccups.runtime._STAR_html_mode_STAR_ = mode;

try{return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_5521;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__5522){
var vec__5524 = p__5522;
var name = cljs.core.nth.call(null,vec__5524,(0),null);
var value = cljs.core.nth.call(null,vec__5524,(1),null);
if(value === true){
if(hiccups.runtime.xml_mode_QMARK_.call(null)){
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__5525){
var vec__5528 = p__5525;
var tag = cljs.core.nth.call(null,vec__5528,(0),null);
var content = cljs.core.nthnext.call(null,vec__5528,(1));
if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string'))){
throw [cljs.core.str(tag),cljs.core.str(" is not a valid tag name")].join('');
} else {
}

var vec__5529 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));
var _ = cljs.core.nth.call(null,vec__5529,(0),null);
var tag__$1 = cljs.core.nth.call(null,vec__5529,(1),null);
var id = cljs.core.nth.call(null,vec__5529,(2),null);
var class$ = cljs.core.nth.call(null,vec__5529,(3),null);
...
var vec__5531 = hiccups.runtime.normalize_element.call(null,element);
var tag = cljs.core.nth.call(null,vec__5531,(0),null);
var attrs = cljs.core.nth.call(null,vec__5531,(1),null);
var content = cljs.core.nth.call(null,vec__5531,(2),null);
if(cljs.core.truth_((function (){var or__3813__auto__ = content;
